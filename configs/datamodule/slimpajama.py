...
@dataclass
class SlimPajamaConfig(DataModuleConfig):
    _target_: str =  'forgetting_transformer.datamodule.slimpajama.SlimPajamaDataModule'
    # This is a custom resolver. Note inside data_dir refers to the root config node
    data_dir: str = '${join_path:${data_dir},slimpajama}'
