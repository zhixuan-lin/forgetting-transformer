...
class Mamba2Mixer(nn.Module):
    ...
    def __init__(self, config: Mamba2Config, layer_idx: int):
        ...
        assert config.num_heads * config.head_dim == self.intermediate_size
        ...
        # )
        assert self.n_groups == 1, "Just in case. The below code uses n_groups"
    ...
    def cuda_kernels_forward(
        ...
        # if no cache is found, calling the kernel
            ...
            if attention_mask is not None and attention_mask.shape[1] > 1 and attention_mask.shape[0] > 1:
                # TODO: this actually wouldn't work because conv has bias
            ...
            if self.training and cache_params is None:
                ...
                if causal_conv1d_fn is None or self.activation not in ["silu", "swish"]:
                    ...
                    if cache_params is not None:
                        cache_params.conv_states[self.layer_idx].copy_(F.pad(hidden_states_B_C.transpose(1, 2), (self.conv_kernel_size - seq_len, 0)))
