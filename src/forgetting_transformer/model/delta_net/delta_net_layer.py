...
class DeltaNet(nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        if o.ndim == 5:
            # Looks like a bug in recurrent fuse
            o = o.squeeze(0)
    ...
    def init_state(self, batch_size: int) -> Tuple[torch.Tensor]:
        ...
        if self.use_short_conv:
            ...
            state += (param.new_zeros(batch_size, self.key_dim, self.conv_size, dtype=dtype),
                      param.new_zeros(batch_size, self.key_dim, self.conv_size, dtype=dtype),
                      param.new_zeros(batch_size, self.value_dim, self.conv_size, dtype=dtype))
