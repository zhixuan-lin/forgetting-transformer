...
* [2026-02-25] We fix a bug related to token shift when `attention_mask` is not None during decoding
* [2025-08-11] Added support for [Adaptive Computation Pruning](https://arxiv.org/abs/2504.06949). We also simplified the dependencies when using this repo as a library.
